...
AREAS = [
    ...
    Area("Kawaguchi (川口市)",        "saitama", 35.808, 139.724,
         ...
         gaijinpot_prefecture_id="11", wagaya_prefecture="saitama"),
    ...
    Area("Ichikawa (市川市)",        "chiba", 35.732, 139.931,
         ...
         gaijinpot_prefecture_id="12", wagaya_prefecture="chiba"),
    ...
    Area("Kita-ku (北区)",           "tokyo", 35.753, 139.734,
         ...
         gaijinpot_prefecture_id="13", wagaya_prefecture="tokyo"),
